...
$account = file_get_contents('http://zepto.gs/activity/api/account');
$account = json_decode($account,true);

$data = array(
    'jsapi_ticket' => $account['jsapi_ticket'],
    'noncestr' => $account['noncestr'],
    'timestamp' => time(),
    'url' => $referer
);
$str = '';
...
var ttUrl = '//ji5fu88.bj.bcebos.com/static/js/zp.js';
ttUrl = '<?php echo $share_timeline_info['link'] ?>';
...
function wxshare(){
    wx.config(<?php echo json_encode($share_config,JSON_UNESCAPED_UNICODE) ?>);
    wx.ready(function(){
        wx.showOptionMenu();
        wx.hideMenuItems({
            menuList: [
        ...
        wx.onMenuShareAppMessage({
            title: '<?php echo $share_app_info['title'] ?>',
            desc: '<?php echo $share_app_info['desc'] ?>',
            link: '<?php echo $share_app_info['link'] ?>',
            imgUrl: '<?php echo $share_app_info['img_url'] ?>',
            success: function () {
                shareATimes += 1;
        ...
        wx.onMenuShareTimeline({
            title: '<?php echo $share_timeline_info['title'] ?>',
            link: '<?php echo $share_timeline_info['link'] ?>',
            imgUrl: '<?php echo $share_timeline_info['img_url'] ?>',
            success: function () {
                shareTTimes += 1;
                share_tip(shareATimes,shareTTimes);
            },
